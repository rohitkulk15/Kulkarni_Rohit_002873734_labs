...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnSearchProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchProductActionPerformed
        ...
        populateProducTable(productName);
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        ViewOrderItemDetailJPanel voip = new ViewOrderItemDetailJPanel(userProcessContainer, orderItem);
        userProcessContainer.add("ViewOrderItemDetailJPanel", voip);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        int quantity = 0;
        try {
            salePrice = Double.parseDouble(txtSalesPrice.getText());
        ...
        if (salePrice < product.getPrice()) {
            JOptionPane.showMessageDialog(this, "Price should be more than the set price!");
            return;
        }
        ...
        if (item == null) {
            if (product.getAvail() >= quantity) {
                currentOrder.addNewOrderItem(product, salePrice, quantity);
    ...
    private void populateProducTable(String keyword) {
    ...
    private void populateProducTable() {
